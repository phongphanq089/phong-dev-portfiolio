...
export const CreepyButton = ({
	...
	return (
		...
		>
			<span
				ref={eyesRef}
				className="absolute flex items-center gap-[0.375em] right-[0.7em] bottom-[0.3em] h-[0.75em] z-0 pointer-events-none"
			>
				<motion.span
					className="relative w-[0.5em] bg-white rounded-full overflow-hidden"
			...
			<motion.span
				className={cn(
					"absolute inset-0 block rounded-xl bg-primary-color text-white font-bold",
